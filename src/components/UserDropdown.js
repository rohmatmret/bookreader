...
const UserDropdown = () => {
  ...
  const packageName = Cookies.get('package_name');
          ...
          {menu && (
            <div
              className={packageName ? 
                ...
                :
                "origin-top-right absolute right-0 mt-10 transition duration-150 ease-out w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
              }
              role="menu"
