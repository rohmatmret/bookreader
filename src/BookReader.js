...
BookReader.prototype.setup = function (options) {
  ...
  if (options.getNumLeafs)
    BookReader.prototype.getNumLeafs = options.getNumLeafs;
  if (options.getPageWidth)
    BookReader.prototype.getPageWidth = options.getPageWidth;
  if (options.getPageHeight)
    BookReader.prototype.getPageHeight = options.getPageHeight;
  if (options.getPageURI) BookReader.prototype.getPageURI = options.getPageURI;
  if (options.getPageSide)
    BookReader.prototype.getPageSide = options.getPageSide;
  if (options.getPageNum) BookReader.prototype.getPageNum = options.getPageNum;
  if (options.getPageProp)
    BookReader.prototype.getPageProp = options.getPageProp;
  if (options.getSpreadIndices)
    BookReader.prototype.getSpreadIndices = options.getSpreadIndices;
  if (options.leafNumToIndex)
    BookReader.prototype.leafNumToIndex = options.leafNumToIndex;
...
BookReader.prototype.getActivePageContainerElements = function () {
  let containerEls = Object.values(this._modes.mode2Up.pageContainers).map(
    (pc) => pc.$container[0]
  );
...
Object.defineProperty(BookReader.prototype, "leafEdgeL", {
  ...
  set(newVal) {
    this._modes.mode2Up.leafEdgeL = newVal;
  },
});
/** @deprecated unused outside Mode2Up */
Object.defineProperty(BookReader.prototype, "leafEdgeR", {
  ...
  set(newVal) {
    this._modes.mode2Up.leafEdgeR = newVal;
  },
});
...
BookReader.prototype.initParams = function () {
  ...
  if (
    "undefined" != typeof this.titleLeaf &&
    this._models.book.getNumLeafs() > 2
  ) {
...
BookReader.prototype.resize = function () {
  ...
  if (this.constMode1up == this.mode) {
    ...
    if (this.twoPage.autofit) {
      ...
      if (
        this.twoPage.totalWidth < this.refs.$brContainer.prop("clientWidth")
      ) {
        center.percentageX = 0.5;
        doRecenter = true;
      }
      if (
        this.twoPage.totalHeight < this.refs.$brContainer.prop("clientHeight")
      ) {
...
BookReader.prototype.lazyLoadThumbnails =
  ModeThumb.prototype.lazyLoadThumbnails;
exposeOverrideableMethod(
  ModeThumb,
  "_modes.modeThumb",
  "lazyLoadThumbnails",
...
BookReader.prototype._isIndexDisplayed = function (index) {
  ...
  return this.constMode1up == this.mode
    ? this.displayedIndices.slice(1, -1).includes(index)
    : this.displayedIndices
  ...
  if (this.constMode1up == this.mode) {
    ...
    return parseInt(
      this.refs.$brContainer.prop("clientHeight") -
        (this._models.book.getPageHeight(this.currentIndex()) / this.reduce) *
          0.03
    );
  }
...
BookReader.prototype.onePageGetAutofitHeight =
  Mode1Up.prototype.getAutofitHeight;
exposeOverrideableMethod(
  Mode1Up,
  "_modes.mode1Up",
  "getAutofitHeight",
...
BookReader.prototype.onePageCalculateReductionFactors =
  Mode1Up.prototype.calculateReductionFactors;
exposeOverrideableMethod(
  Mode1Up,
  "_modes.mode1Up",
...
/** @deprecated not used outside Mode1Up */
BookReader.prototype.onePageCalculateViewDimensions =
  Mode1Up.prototype.calculateViewDimensions;
exposeOverrideableMethod(
  Mode1Up,
  "_modes.mode1Up",
  "calculateViewDimensions",
  "onePageCalculateViewDimensions"
);
/** @deprecated not used outside Mode1Up */
...
BookReader.prototype.twoPageGetAutofitReduce =
  Mode2Up.prototype.getAutofitReduce;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
  "getAutofitReduce",
...
BookReader.prototype.calculateSpreadSize =
  Mode2Up.prototype.calculateSpreadSize;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
  "calculateSpreadSize",
...
/** @deprecated not used outside BookReader, Mode2Up */
BookReader.prototype.getSpreadSizeFromReduce =
  Mode2Up.prototype.getSpreadSizeFromReduce;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
BookReader.prototype.twoPageCalculateReductionFactors =
  Mode2Up.prototype.calculateReductionFactors;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
  "calculateReductionFactors",
  "twoPageCalculateReductionFactors"
);
/** @deprecated unused */
...
/** @deprecated unused outside BookReader, Mode2Up */
BookReader.prototype.prepareFlipLeftToRight =
  Mode2Up.prototype.prepareFlipLeftToRight;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
/** @deprecated unused outside BookReader, Mode2Up */
BookReader.prototype.prepareFlipRightToLeft =
  Mode2Up.prototype.prepareFlipRightToLeft;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
/** @deprecated unused outside Mode2Up */
BookReader.prototype.twoPageLeftFlipAreaLeft =
  Mode2Up.prototype.leftFlipAreaLeft;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
  "leftFlipAreaLeft",
...
/** @deprecated unused outside Mode2Up */
BookReader.prototype.twoPageRightFlipAreaLeft =
  Mode2Up.prototype.rightFlipAreaLeft;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
  "rightFlipAreaLeft",
...
/** @deprecated unused outside BookReader, Mode2Up */
BookReader.prototype.gutterOffsetForIndex =
  Mode2Up.prototype.gutterOffsetForIndex;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
/** @deprecated unused outside BookReader, Mode2Up */
BookReader.prototype.jumpIndexForLeftEdgePageX =
  Mode2Up.prototype.jumpIndexForLeftEdgePageX;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
/** @deprecated unused outside BookReader, Mode2Up */
BookReader.prototype.jumpIndexForRightEdgePageX =
  Mode2Up.prototype.jumpIndexForRightEdgePageX;
exposeOverrideableMethod(
  Mode2Up,
  "_modes.mode2Up",
...
BookReader.prototype.switchNavbarControls =
  Navbar.prototype.switchNavbarControls;
exposeOverrideableMethod(Navbar, "_components.navbar", "switchNavbarControls");
BookReader.prototype.updateViewModeButton =
  Navbar.prototype.updateViewModeButton;
...
/** @deprecated unused outside this file */
BookReader.prototype.updateNavIndexThrottled = utils.throttle(
  BookReader.prototype.updateNavIndex,
  250,
  false
);
/** @deprecated unused */
BookReader.prototype.updateNavIndexDebounced = utils.debounce(
  BookReader.prototype.updateNavIndex,
  500,
  false
);
  ...
  if (_swipe.deltaT > maxSwipeTime && !_swipe.didSwipe) {
    if (_swipe.mightBeDragging) {
      ...
      self.refs.$brContainer
        .scrollTop(
          self.refs.$brContainer.scrollTop() - event.clientY + _swipe.lastY
        )
        .scrollLeft(
          self.refs.$brContainer.scrollLeft() - event.clientX + _swipe.lastX
        );
    }
  }
